...
db_path = "sqlite:///model_cmp_m_log.db"
...
abc = pyabc.ABCSMC(models=[solver.ode_model1, solver.ode_model2, solver.ode_model3],
                   parameter_priors=[para_prior1, para_prior2,para_prior3],
